...
<head>
    ...
    <title>Absensi Nagari Guguak Malalo</title>
...
<body>
    <div class="wrapper">
        <div class="sidebar" data-image="../assets/img/sidebar-5.jpg" data-color="blue">
            <!--
                Tip 1: You can change the color of the sidebar using: data-color="purple | black | blue | green | orange | red"
            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="<?= base_url() ?>" class="simple-text">
                        <img src="<?= base_url('assets/img/Guguak-Malalo.png') ?>"alt="Guguak-Malalo"height="100"width="80" class="img-fluid-auto">
                    </a>
                </div>
                <ul class="nav">
                    <li class="nav-item">
                ...
                <div class="container">
                    <nav>
                        <p class="copyright text-center">
                            &copy; 2023 Manajemen Informatika <a href="http://Miftahul-Khaira.co.id">Miftahul Khaira</a>
                        </p>
                    </nav>
                </div>
            </footer>
