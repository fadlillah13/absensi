...
<head>
    ...
    <title>Asensi Guguak Malalo | Login</title>
    <link rel="stylesheet" href="<?= base_url('assets/css/bootstrap.min.css') ?>">
    <link rel="stylesheet" href="<?= base_url('assets/vendor/font-awesome/css/font-awesome.min.css') ?>">
    <body>
    <div background='../assets/img/malalo.jpg'alt="malalo"class background-size="cover"height="auto"class="auto"> 
</head>
<body>
    <div class="wrapper">
        <div class="container">
                    ...
                    <section id="login-body" class="pt-3">
                        <div class="card border-0 shadow pt-3">
                            <div class="card-header bg-transparent border-bottom-0 pb-0 text-center">
                                <img src="<?= base_url('assets/img/Guguak-Malalo.png') ?>" alt="Guguak-Malalo"height="120"width="100" class="img-fluid mx-auto d-block">
                                <div class="mt-3">
                                    <span class="card-info text-center">Login Untuk Melakukan Absensi</span>
                                </div>
                            </div>
                            <div class="card-body">
